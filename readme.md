...
You can find the latest changelogs [here](https://github.com/YAOSPA-NG/YAOSPA_vendor_yaosp/raw/YAOSPA-NG-20171109/misc/docs/Changelog.txt).

## Known issues ##

You can find the currently known issues list [here](https://github.com/YAOSPA-NG/YAOSPA_vendor_yaosp/raw/YAOSPA-NG-20171109/misc/docs/Known_issues.txt).
...
$ repo init -u git@gitlab.com:YAOSPA-NG/YAOSPA_manifest.git -b YAOSPA-NG-20171109
```
